...
this with the :meth:`~quart_jwt_extended.JWTManager.user_claims_loader`
decorator, discussed in the previous section. However, if we pass the username
to the :meth:`~quart_jwt_extended.JWTManager.user_claims_loader`, we would end
...
:meth:`~quart_jwt_extended.JWTManager.user_claims_loader`
...
:func:`~quart_jwt_extended.create_access_token` function, which will then be
passed as is to the :meth:`~quart_jwt_extended.JWTManager.user_claims_loader`.
...
:meth:`~quart_jwt_extended.JWTManager.user_identity_loader`, which lets you
take any object passed in to :func:`~quart_jwt_extended.create_access_token`
