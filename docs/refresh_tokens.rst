...
Quart-JWT-Extended supports refresh tokens out of the box. These are long
...
with :func:`~quart_jwt_extended.jwt_required` and access tokens cannot access
and endpoint that is protected with
:func:`~quart_jwt_extended.jwt_refresh_token_required`.
